...
#define PMLT4_ADDRESS               0x1000
#define PDPT_ADDRESS                0x2000
#define PDT_ADDRESS                 0x3000
#define FIRST_PT_ADDRESS            0x4000
#define FRAME_PT_ADDRESS            0x5000
#define PAGE_BITMAP_ADDRESS         0x6000

#define VIDEO_DRIVER_ADDRESS        0xFFFFFFFFFD000000
#define KERNEL_HIGHER_HALF_KKERNEL  0xFFFFFFFF80000000
#define DEFAULT_FONT_ADDRESS        0x0000000000101000
